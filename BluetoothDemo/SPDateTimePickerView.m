...
- (UIView *)contentView {
    ...
    if (!_contentView) {
        ...
        _contentView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWith, 420)];
...
- (UIPickerView *)pickerView {
    ...
    if (!_pickerView) {
        ...
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 380)];
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        ...
        self.contentView.frame = CGRectMake(0, ScreenHeight-420, ScreenWith, 420);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        ...
        self.contentView.frame = CGRectMake(0, ScreenHeight, ScreenWith, 420);
